"""Shared helpers for the gemma3_12b per-step scripts.

Mirror of qwen4b/scripts/_common.py, targeting `google/gemma-3-12b-pt` — a
...
hybrid). The 4B/12B/27B are multimodal wrappers; only the language model is used.
...
MODEL_SPEC = ModelSpec(
    hf_name="google/gemma-3-12b-pt", approx_params="12B", dtype="bfloat16"
)
