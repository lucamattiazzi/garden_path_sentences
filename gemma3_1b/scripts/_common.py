"""Shared helpers for the gemma3_1b per-step scripts.

Mirror of qwen4b/scripts/_common.py, targeting `google/gemma-3-1b-pt` — a
...
hybrid). The 1B is text-only (Gemma3ForCausalLM); the layout is flat.
...
MODEL_SPEC = ModelSpec(
    hf_name="google/gemma-3-1b-pt", approx_params="1B", dtype="bfloat16"
)
