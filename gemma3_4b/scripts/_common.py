"""Shared helpers for the gemma3_4b per-step scripts.

Mirror of qwen4b/scripts/_common.py, targeting `google/gemma-3-4b-pt` — a
...
MODEL_SPEC = ModelSpec(
    hf_name="google/gemma-3-4b-pt", approx_params="4B", dtype="bfloat16"
)
